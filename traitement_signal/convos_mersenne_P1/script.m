...
% quelques sons
fichiers = {'mesure_mains_binaurale_inverse_mersenneP1','handclaps_51k2';
'mesure_cle_binaurale_inverse_mersenneP1','cles_51k2';
'mesure_musique_binaurale_inverse_mersenneP1','chanson_51k2'};

RI = 'mesure_RI_binaurale_mersenne_recepteurP1_position_inverse';
...
while count<=len
	...
	wavwrite(result_ref, 51200, ['ref_' son  suffixe '.wav']);
	...
	% print(['temporel_' son  suffixe '.png'],'-dpng');
