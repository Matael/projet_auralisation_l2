...
% quelques sons
fichiers = {'mesure_mains_binaurale_verstableau_mersenneP1','handclaps_51k2';
'mesure_cle_binaurale_verstableau_mersenneP1','cles_51k2';
'mesure_musique_binaurale_verstableau_mersenneP1','chanson_51k2'};

RI = 'mesure_RI_binaurale_mersenne_recepteurP1_vers_mur_aavec_tableau';
